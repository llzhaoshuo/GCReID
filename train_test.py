...
def main(config):
    ...
    if config.mode == 'train':  # train mode
        ...
        # continual loop
        for current_step in range(start_train_step, loaders.total_step): # step : range(0, 3)
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--mode', type=str, default='train', help='trian_10, train_5, train, test or visualize')
    # parser.add_argument('--mode', type=str, default='visualize', help='trian_10, train_5, train, test or visualize')
    ...
    parser.add_argument('--train_dataset', nargs='+', type=str,
                        default=['market', 'subcuhksysu','duke', 'msmt17','cuhk03', 'sensereid','cuhk02'])
    # parser.add_argument('--train_dataset', nargs='+', type=str,
    ...
    # parser.add_argument('--test_dataset', nargs='+', type=str,default=['duke','msmt17','market', 'subcuhksysu','cuhk03','grid', 'sensereid','cuhk01',
    #                              'cuhk02','viper','ilids','prid'])

    # parser.add_argument('--test_dataset', nargs='+', type=str,default=['market','duke','cuhk03','prid','cuhk02','cuhk01','grid'])
    # parser.add_argument('--test_dataset', nargs='+', type=str,default=['market','duke','cuhk03','prid','cuhk02','grid'])
    ...
    # parser.add_argument('--k', type=int, default=4, help='images count of a person in a batch')
    # parser.add_argument('--p', type=int, default=4, help='vehicle count in a batch')
    # parser.add_argument('--k', type=int, default=4, help='images count of a vehicle in a batch')
    ...
    # 车辆模型
    # parser.add_argument('--resume_test_model', type=str, default='/media/lzs/de2ef254-eaa4-4486-b00b-ab367ed2a6d8/home/lzs/LifelongReID/results/2022-03-25-08-21-14_GCN无提炼_车辆数据集/models/2/model_tasknet_49.pkl', help='')
    ...
    # parser.add_argument('--visualize_mode', type=str, default='intra-camera',
    #                     help='inter-camera, intra-camera, all, only availiable under visualize model')
    ...
    # parser.add_argument('--meta_graph_vertex_num', type=int, default=32,
    #                     help='meta_graph_vertex_num')
    
    # parser.add_argument('--weight_r', type=float, default=0.0005, help='weight for stablity loss')
    # parser.add_argument('--weight_r', type=float, default=0.0005, help='weight for fd loss')
    # parser.add_argument('--weight_r', type=float, default=0.001, help='weight for fd loss')
    # parser.add_argument('--weight_r', type=float, default=0.00025, help='weight for fd loss')
    # parser.add_argument('--weight_r', type=float, default=0.005, help='weight for fd loss')
    # parser.add_argument('--weight_r', type=float, default=0.01, help='weight for fd loss')
    # parser.add_argument('--weight_r', type=float, default=0.0001, help='weight for fd loss')
    # parser.add_argument('--weight_r', type=float, default=0.02, help='weight for fd loss')
